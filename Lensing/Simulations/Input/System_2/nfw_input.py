...
path = '/Volumes/T7 Shield/Simulations/Output/NFW'
...
glafic.set_lens(1, 'anfw', 0.261343256161012, 1e11, 0.0, 0.0, 0.107, 23.38, 20, 0.0)
# glafic.set_lens(2, 'pert', 0.261343256161012, 1.0, 20.78, 20.78, 0.001, 360.0, 0.0, 1.0)
glafic.set_point(1, 1.0, 0.0, 0.0)
glafic.setopt_lens(1, 0, 1, 1, 1, 0, 0, 0, 0)
