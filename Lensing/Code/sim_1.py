...
model_output_base = '/home/rommulus/Projects/itng_lensing/Simulations/Output/Sim_1'
base_results_path = '/home/rommulus/Projects/itng_lensing/Simulations/Input/System_4'
...
prior_file = '/home/rommulus/Projects/itng_lensing/Simulations/Input/System_4/prior.dat'
time_delay = False
h0 = False
...
def run_glafic_calculation(params, model_name, worker_temp_dir):
    ...
    base_lens_params = [0.297717684517447, 1.0, 1.06, 1.06, 0.1, 45, 0.5, 2.0]
    ...
    glafic.init(0.3089901684739047, 0.6910098315260953, -1.0, 0.6736, output_path, 0.0, 0.0, 2.12, 2.12, 0.01, 0.01, 1, verb=0)
